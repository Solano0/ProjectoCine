...
class Validator
{
    ...
    */
    ...
    {
        // Se verifica que el valor sea un número entero.
    ...
    */  
    public static function validatePassword($value)
    {
        ...
        if (strlen($value) < 8) {
            ...
            self::$passwordError = 'La contraseña no debe contener caracteres en blanco';
            return false;
        } elseif (!preg_match('/\W/', $value)) {
            self::$passwordError = 'La contraseña debe contener al menos un caracter especial';
            return false;
        } elseif (!preg_match('/\d/', $value)) {
            self::$passwordError = 'La contraseña debe contener al menos un dígito';
            return false;
        } elseif (!preg_match('/[a-z]/', $value)) {
            self::$passwordError = 'La contraseña debe contener al menos una letra minúscula';
            return false;
        } elseif (preg_match('/[A-Z]/', $value)) {
            return true;
        }else{
            self::$passwordError = 'La contraseña debe contenerse al menos una letra mayúscula';
            return false;
        }
    }
    ...
    */
    ...
    /*
    *   Método para validar la inactividad de un usuario en el sitio utilizando una variable de sesión
    *   Parámetros: Ningúno
    *   Retorno: booleano (true si el valor es correcto o false en caso contrario).
    */
        public static function validateSessions()
        {
            $InactividadMax = 3600;
            if ((time() - $_SESSION['tiempo_sesion']) > $InactividadMax) {
                session_destroy();
                return false;
            } else{
